...
const localCases = [
  {
    ...
    result:
      "NIE has found that continued use of VpCI®-126 Blue Film and VpCI®-111 Emitters is an economical and long-lasting method of protection. The easy-to-install emitters minimise remedial work, maintenance, and failure costs. NIE is happy to use such a cost-effective, environmentally friendly product.",
    pdf: "/case-histories/ch486-nie-electrical-cabinets.pdf",
    highlight: true,
  },
  {
    id: "ch483",
    ...
    solution:
      "VpCI®-309 Powder was sprinkled throughout the accessible areas of the dock gate in January 2009. The gate was opened and inspected in September 2013 — having been in active use or anchored at sea for the entire period. Cortec® VpCI®-309 continued to provide protection throughout.",
    result:
      "Harland & Wolff chose to reapply VpCI®-309 Powder as it proved the best corrosion protection for this application — cost effective, environmentally safe, and easy to apply. The powder required no specialised equipment or surface preparation.",
    pdf: "/case-histories/ch483-harland-wolff-dock-gate.pdf",
    highlight: false,
  },
  {
    id: "ch180",
    ...
    problem:
      "Short Brothers wanted to test VpCI®-337 as a universal corrosion preventative for aluminium and other metals, across components, sheets, stacks, and coils stored in multiple environments — including acid environments near pretreatment phosphoric and chromic acid anodising solutions.",
    solution:
      "Four stacks of aluminium alloy plates were fogged with VpCI®-337 spray and placed in four test environments: hot and humid, acid, ambient, and cold and dry. Control stacks without treatment were placed in the same conditions. Results were assessed over three months.",
    result:
      "VpCI®-337 provided effective protection in all environments. In the acid environment, untreated control stacks suffered severe corrosive attack — the VpCI®-337 treated stack showed only minor initial pitting on the top plate. Pretreatment completely removed VpCI®-337 with no contamination issues, confirming compatibility with downstream bonding processes.",
    pdf: "/case-histories/ch180-short-brothers-aerospace.pdf",
    highlight: false,
  },
];

export default function CaseHistoriesPage() {
  return (
    <>
      <HeroSection
        title="Case Histories"
              ...
              >
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                    <div>
                      ...
                      <p className="mt-1 text-grey-600">
                        {c.customer} &mdash; {c.location}
                      </p>
                    </div>
                    <div className="flex-shrink-0 text-right">
                      <p className="text-sm text-grey-500">{c.date}</p>
                  ...
                  <div className="mt-6 pt-5 border-t border-grey-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    ...
                    <Link
                      href="/contact"
                      className="text-sm font-semibold text-navy-900 hover:text-steel-500 transition-colors"
                    >
      ...
      <section className="py-16 sm:py-20 bg-grey-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-navy-900">
              Hundreds More Case Histories
            </h2>
            <p className="mt-4 text-lg text-grey-600 leading-relaxed">
              Cortec® Corporation maintains an extensive library of case histories covering every major industry and application — from pipeline preservation in the Middle East to aerospace component storage in the US. Browse the full global collection at corteccasehistories.com.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-navy-900 hover:bg-navy-800 text-white font-semibold rounded-lg transition-colors text-base focus:outline-none focus:ring-2 focus:ring-navy-500 focus:ring-offset-2"
              >
                Browse Global Case Histories ↗
              </a>
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-navy-900 text-navy-900 hover:bg-navy-900 hover:text-white font-semibold rounded-lg transition-colors text-base"
              >
